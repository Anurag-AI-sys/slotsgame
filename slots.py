import random
MAX_LINES = 3  #constant value so capitals
MAX_BET = 100
MIN_BET = 1
ROWS = 3
COLS = 3
...
def print_slot_machine(columns):
   ...
   for row in range(len(columns[0])):
       for i ,column in enumerate(columns):   #len_columns is the maximumlength of column we have
            if i!= len(columns)-1:
    ...
    while True:
        ...
        if amount.isdigit():
            ...
            if amount > 0:
                ...
                print("Amount enterEnter deposit amount: $100
